...
var canvasHTML = "<section><span id='header'>Multiplayer - Pong</span><br><form action='http://localhost:8000' id='roomSelector' method='post'><input type='radio' name='room' value='0'> Room 0 <br><input type='radio' name='room' value='1'> Room 1 <br><input type='radio' name='room' value='2'> Room 2 <br><input type='submit' value='Join room'></form></section><section><div class='score-board'><div class='player'><p>0</p></div><div class='player'><p>0</p></div></div><canvas id='myCanvas'></canvas><div id='ready-section'><div class='player'><h3>Player 1:</h3><h3>Not ready</h3></div><div class='player'><h3>Player 2:</h3><h3>Not ready</h3></div><h3>Press space to set yourself to ready</h3></div><h2 id='waiting-label'>Waiting for more players</h2></section>";
